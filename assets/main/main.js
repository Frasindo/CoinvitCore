...
function set_login(arr) {
  Cookies.set("dex_blockchain",arr.dex_blockchain,{expires:0.5})
  Cookies.set("dex_address",arr.dex_address,{expires:0.5})
  Cookies.set("dex_logo",arr.dex_logo,{expires:0.5})
  Cookies.set("dex_secret",arr.dex_secret,{expires:0.5})
}
function check_login() {
  dex = Cookies.get("dex_blockchain");
  return dex;
}
function clean_login() {
  Cookies.remove('dex_blockchain');
  Cookies.remove('dex_address');
  Cookies.remove('dex_logo');
  Cookies.remove('dex_secret');
}
