                           ...
                           <div data-toggle="play-animation" data-play="fadeInDown" data-offset="0" data-delay="100" class="panel widget">
                              <div class="panel-body bg-primary">
                                 <div class="row row-table row-flush">
                                    <div class="col-xs-12">
                                       <p class="mb0">{total_trade}
                                       </p>
                                       <h4 class="m0">Total Trade</h4>
                                       <span class="m-t-10"><i class="fa fa-exchange"></i> Trades Total
                                       </span>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="col-md-6">
                           <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget">
                              <div class="panel-body">
                                 ...
                                 <p class="text-danger"></i> {bid_price} IGNIS</p>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget">
                              <div class="panel-body">
                                 ...
                                 <p class="text-green">{ask_price} IGNIS</p>
                              </div>
                           </div>
                        </div>
                     </div>
